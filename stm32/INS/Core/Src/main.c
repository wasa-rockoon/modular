...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_ERROR_Pin|LED_STATUS_Pin|GPS_RESET_Pin|TEMP_LOW_Pin
                          |TEMP_HIGH_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(BNO_RESET_GPIO_Port, BNO_RESET_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LED_ERROR_Pin LED_STATUS_Pin GPS_RESET_Pin TEMP_LOW_Pin
                           TEMP_HIGH_Pin */
  GPIO_InitStruct.Pin = LED_ERROR_Pin|LED_STATUS_Pin|GPS_RESET_Pin|TEMP_LOW_Pin
                          |TEMP_HIGH_Pin;
